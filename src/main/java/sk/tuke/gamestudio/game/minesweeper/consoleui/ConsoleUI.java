	...
	public void newGameStarted() {
		...
		do {
			...
			if (field.getState() == GameState.SOLVED) {
				...
				Score score=new Score(System.getProperty("user.name"), "Minesweeper", 500 - Minesweeper.getInstance().getPlayingSeconds(), new Date());
				try {
...
//		Thread randomOpened = new Thread(() -> {
//
//			try {
...
//				int a = r.nextInt(field.getRowCount());
//				int b = r.nextInt(field.getColumnCount());
//				if (field.getTile(a, b).getState() == State.CLOSED) {
//					field.openTile(a, b);}
//				this.update();
//				this.processInput();}
//            });
